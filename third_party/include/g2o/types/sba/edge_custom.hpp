#ifndef __EDGE_CUSTOM_HPP__
#define __EDGE_CUSTOM_HPP__
...
class G2O_TYPES_SBA_API EdgeCustom
    : public BaseBinaryEdge<2, g2o::Vector2, VertexPointXYZ, VertexSE3Custom> {
    public:
